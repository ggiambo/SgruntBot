...
class BitcoinUSDTest : ActionTest() {
    ...
    @Test
    fun testPositive() {
        bitcoinUSD.doAction(message(("!btc")), Context())
    ...
    @Test
    fun testPositive2() {
        bitcoinUSD.doAction(message(("blah banf quanto vale un bitcoin? yadda yadda")), Context())
    ...
    @Test
    fun testNegative() {
        bitcoinUSD.doAction(message(("!btce__")), Context())
